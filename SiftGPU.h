...
public:
    ...
    float			    _timing[10];
    inline const char*  GetCurrentImagePath()
    {
        return _imgpath;
    }
public:
...
public:
    ...
    inline int  CreateContextGL()
    {
        return _CreateContextGL();
    }
    inline int  VerifyContextGL()
    {
        return _VerifyContextGL();
    }
